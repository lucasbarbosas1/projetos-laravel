...
<div class="container">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title text-center">Editar Cliente</h3>
        </div>

        <div class="panel-body">
            {{ HTML::ul($errors->all()) }}

                {{ Form::open(array('url' => 'cliente/'.$id,'class'=>"form-horizontal")) }}
                @csrf
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="CGC" name="CGC" value="{{$cliente->CGC}}">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            @php
                                $date=date('d-m-Y', strtotime($cliente->DtNascimento));
                            @endphp
                            <input type="text" class="form-control" id="data-nascimento" name="DtNascimento" value="{{$date}}">
                        </div>
                    </div>
                </fieldset>
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="tel" class="form-control" id="contato" name="Contato" value="{{$cliente->Contato}}">
                        </div>
                    </div>
                </fieldset>
                <button type="submit" class="btn btn-primary">
                    <span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Editar
                </button>
            </form>
        </div>
    </div>
